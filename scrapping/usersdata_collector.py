...
from .cnn_filter import FilterForwarder

from threading import Thread


class UsersDataCollector(Controlled, Collecting):
    """
    ...
    def __init__(self, credentials_pool: CredentialsPool = None, data_manager: DataManager = None, filter_forwarder=None):
        Controlled.__init__(self)
        Collecting.__init__(
            self, credentials_pool=credentials_pool, data_manager=data_manager)
        self.filter_forwarder = filter_forwarder
